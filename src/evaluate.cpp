...
namespace {
  ...
  constexpr int SafeCheck[][3] = {
      {}, {}, {792, 1283, 0}, {645, 967, 400}, {1084, 1897, 257}, {772, 1119, 400}
  };
...
#undef S
  ...
  private:
    ...
    template<PieceType Pt> int analyse_check(Square ksq, Bitboard checks, Bitboard interpositions) const;
  ...
  Score Evaluation<T>::king() const {
    ...
    if (knightChecks & safe)
        kingDanger += analyse_check<KNIGHT>(ksq, knightChecks & safe, 0);
    else
