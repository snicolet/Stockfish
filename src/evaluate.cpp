...
namespace {
  ...
  { { S(0, 0), S( 0, 0), S(19, 37), S(24, 37), S(44, 97), S(45,116) },   // Minor on Defended
    { S(0, 0), S( 0, 0), S( 9, 14), S( 9, 14), S( 7, 14), S(34, 58) } }, // Rook on Defended
  { { S(0, 0), S( 0,32), S(33, 41), S(31, 50), S(41,100), S(45,114) },   // Minor on Weak
    { S(0, 0), S( 0,27), S(26, 57), S(26, 57), S(0 , 43), S(33, 61) } }  // Rook on Weak
  };
