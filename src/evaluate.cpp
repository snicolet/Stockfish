...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score ThreatByPawnPush   = S( 36, 30);
...
#undef S
  ...
  Score Evaluation<T>::threats() const {
    ...
    score +=  ThreatByPawnPush * popcount(pawn_attacks_bb<Us>(b) & nonPawnEnemies)
            + ThreatByPawnPush * popcount(b & pawn_attacks_bb<Them>(nonPawnEnemies));
