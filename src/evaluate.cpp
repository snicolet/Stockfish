...
namespace {
  ...
  { { S(0, 0), S( 0, 0), S(19, 37), S(24, 37), S(44, 97), S(55,126) },   // Minor on Defended
    { S(0, 0), S( 0, 0), S( 9, 14), S( 9, 14), S( 7, 14), S(44, 68) } }, // Rook on Defended
  { { S(0, 0), S( 0,32), S(33, 41), S(31, 50), S(41,100), S(55,124) },   // Minor on Weak
    { S(0, 0), S( 0,27), S(26, 57), S(26, 57), S(0 , 43), S(43, 71) } }  // Rook on Weak
  };
