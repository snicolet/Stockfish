...
namespace {
  ...
  { { S(0, 0), S( 0, 0), S(19, 37), S(24, 37), S(44, 97), S(43,114) },   // Minor on Defended
    { S(0, 0), S( 0, 0), S( 9, 14), S( 9, 14), S( 7, 14), S(32, 56) } }, // Rook on Defended
  { { S(0, 0), S( 0,32), S(33, 41), S(31, 50), S(41,100), S(43,112) },   // Minor on Weak
    { S(0, 0), S( 0,27), S(26, 57), S(26, 57), S(0 , 43), S(31, 48) } }  // Rook on Weak
  };
