...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-25, 0), S(-16, 0), S(-10, 0), S (1, 0) },
   { S(-21, 0), S( -8, 0), S(  3, 0), S(10, 0) },
   { S(-21, 0), S( -9, 0), S(  2, 0), S(12, 0) },
   { S(-22, 0), S( -6, 0), S(  5, 0), S(12, 0) },
   { S(-22, 0), S( -7, 0), S(  6, 0), S(11, 0) },
   { S(-21, 0), S( -7, 0), S(  6, 0), S(12, 0) },
   { S(-12, 0), S(  4, 0), S( 14, 0), S(22, 0) },
   { S(-23, 0), S(-15, 0), S( -5, 0), S( 5, 0) }
  },
  { // Queen
