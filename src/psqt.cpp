...
constexpr Score A = S(0, 2);
constexpr Score B = S(0, 3);
...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  { },
  { // Pawn
   { S(  0, 0), S(  0, 0), A + S(  0, 0), B + S( 0, 0) },
   { S(-11, 7), S(  6,-4), A + S(  7, 8), B + S( 3,-2) },
   { S(-18,-4), S( -2,-5), A + S( 19, 5), B + S(24, 4) },
   { S(-17, 3), S( -9, 3), A + S( 20,-8), B + S(35,-3) },
   { S( -6, 8), S(  5, 9), A + S(  3, 7), B + S(21,-6) },
   { S( -6, 8), S( -8,-5), A + S( -6, 2), B + S(-2, 4) },
   { S( -4, 3), S( 20,-9), A + S( -8, 1), B + S(-4,18) }
  },
  { // Knight
