...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11, 7), S(  6,-4), S( A +  7, A +  8), S(B +  3, B + -2) },
   { S(-18,-4), S( -2,-5), S( A + 19, A +  5), S(B + 24, B +  4) },
   { S(-17, 3), S( -9, 3), S( A + 20, A + -8), S(B + 35, B + -3) },
   { S( -6, 8), S(  5, 9), S( A +  3, A +  7), S(B + 21, B + -6) },
   { S( -6, 8), S( -8,-5), S( A + -6, A +  2), S(B + -2, B +  4) },
   { S( -4, 3), S( 20,-9), S( A + -8, A +  1), S(B + -4, B + 18) }
  },
  { // Knight
