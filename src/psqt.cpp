...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-25, 0), S(-16, 0), S(-10 + C, B), S( 6 + C, B) },
   { S(-21, 0), S( -8, 0), S( -3 + C, B), S( 0 + C, B) },
   { S(-21, 0), S( -9, 0), S( -4 + C, B), S( 2 + C, B) },
   { S(-22, 0), S( -6, 0), S( -1 + C, B), S( 2 + C, B) },
   { S(-22, 0), S( -7, 0), S(  0 + C, B), S( 1 + C, B) },
   { S(-21, 0), S( -7, 0), S(  0 + C, B), S( 2 + C, B) },
   { S(-12, 0), S(  4, 0), S(  8 + C, B), S(12 + C, B) },
   { S(-23, 0), S(-15, 0), S(-11 + C, B), S(-5 + C, B) }
  },
  { // Queen
