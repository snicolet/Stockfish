...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   ...
   { S( -4,  6), S(-23,  0), S(  6,  0), S( 20,  0), S( 40,  0), S( 17,  0), S(  4,  0), S( -8,  0) },
   { S( 13, 10), S(  0,  5), S(-13,  4), S(  1,  0), S( 11,  0), S( -2,  0), S(-13, 14), S(  5,  9) },
   { S(  5, 28), S(-12, 20), S( -7, 21), S( 22, 28), S( -8, 30), S( -5,  7), S(-15,  6), S( -8, 13) },
   { S( -7,  0), S(  7,  4), S( -3, 12), S(-13, 21), S(  5, 25), S(-16, 19), S( 10,  4), S( -8,  7) }
  };
