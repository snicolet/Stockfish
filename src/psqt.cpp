...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-12, 5), S(  1,-4), S(  7, 8), S( 3,-2) },
   { S(-19,-6), S( -7,-5), S( 19, 5), S(24, 4) },
   { S(-18, 1), S(-14, 3), S( 16,-8), S(31,-3) },
   { S( -7, 6), S(  0, 9), S( -1, 7), S(17,-6) },
   { S( -7, 6), S(-13,-5), S(-10, 2), S(-6, 4) },
   { S( -5, 1), S( 15,-9), S( -8, 1), S(-4,18) },
   { S(  0, 0), S(  0, 0), S(  0, 0), S( 0, 0) }
  },
  { // Knight
